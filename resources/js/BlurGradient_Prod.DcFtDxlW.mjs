...
import {init_jsx_runtime as t, init_npm_react_18_2 as n, p as r, se as i} from "./react.BGOYdRaa.mjs";
import {init_framer_motion_5EXT2AMG as a, motion as o} from "./motion.Cp-kJPeu.mjs";
import {ControlType as s, addPropertyControls as c, init_framer_6HDYDFRL as l} from "./framer.B1FS9TMt.mjs";
function u({blur: e, borderRadius: t, direction: n, transition: a}) {
    let s = i( () => [{
...
More components at [Framer University](https://frameruni.link/cc).`
    ...
    u.displayName = `Blur Gradient`,
    d = u
}
);
export {d as BlurGradient_Prod_default, f as init_BlurGradient_Prod};
//# sourceMappingURL=BlurGradient_Prod.DcFtDxlW.mjs.map
